  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-50 lg:bg-slate-950">
      ...
      <div className="relative z-10 min-h-screen">
        <div className="container-page flex min-h-screen items-center py-6 md:py-8">
          <div className="grid w-full gap-5 lg:grid-cols-[minmax(0,1fr)_minmax(400px,520px)] lg:items-center">
            <div className="hidden min-h-[560px] items-end lg:flex">
              <div className="max-w-[520px] rounded-[24px] border border-white/12 bg-[linear-gradient(180deg,rgba(15,23,42,0.78),rgba(15,23,42,0.64))] px-5 py-5 shadow-[0_28px_60px_rgba(15,23,42,0.22)] backdrop-blur-md">
            ...
            <div className="flex items-center justify-center lg:justify-end">
              <div className="w-full max-w-[520px] rounded-[28px] border border-white/70 bg-white/74 p-5 shadow-[0_22px_56px_rgba(15,23,42,0.12)] backdrop-blur-xl lg:bg-white/12 lg:shadow-[0_24px_64px_rgba(15,23,42,0.22)] md:p-7">
                ...
                <h1 className="mt-5 text-4xl font-bold tracking-tight text-slate-900 lg:text-white md:text-[3.2rem] lg:[text-shadow:0_10px_30px_rgba(15,23,42,0.35)]">
