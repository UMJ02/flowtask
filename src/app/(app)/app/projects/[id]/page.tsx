    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_380px]">
        <div className="space-y-4">
          ...
          {access.canViewActivity ? <ActivityTimeline items={activity} title="Bitácora del proyecto" description="Cambios de estado, miembros, adjuntos y edición del proyecto." /> : null}
        </div>
        <div className="space-y-4">
