...
export default async function OrganizationRolesPage() {
  ...
  const { roleTemplates, permissionDefinitions, membersByRole } = await getOrganizationRolesAndPermissions(activeOrganizationId);
  ...
  return (
    <div className="space-y-4">
      ...
      <OrganizationRolesPanel roles={roleTemplates} permissions={permissionDefinitions} />
