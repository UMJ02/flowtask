    ...
    <div className="space-y-4">
      ...
      <div className="space-y-4">
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)]">
          ...
          <div className="rounded-[24px] border border-slate-200/90 bg-white/[0.94] p-4 shadow-[0_10px_30px_rgba(15,23,42,0.04)] md:p-5">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Gestión operativa</p>
            <h3 className="mt-2 text-lg font-bold text-slate-900">Seguimiento, responsables y acceso compartido</h3>
