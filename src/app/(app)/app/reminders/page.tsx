...
export default async function RemindersPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <ReminderForm tasks={tasks.map((task: { id: string; title: string }) => ({ id: task.id, title: task.title }))} projects={projects.map((project: { id: string; title: string }) => ({ id: project.id, title: project.title }))} />
