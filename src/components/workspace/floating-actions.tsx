...
export function WorkspaceFloatingActions() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed right-0 top-0 z-50 flex h-screen w-[380px] max-w-[92vw] flex-col border-l border-emerald-200 bg-white/[0.98] shadow-[-24px_0_54px_rgba(15,23,42,0.14)] transition-transform duration-300',
