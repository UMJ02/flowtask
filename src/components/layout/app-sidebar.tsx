        ...
        <div className="mb-4 rounded-[26px] bg-white/5 p-3 ring-1 ring-white/10 transition-all duration-300">
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xl font-bold">Workspace</p>
            </div>
            <button
              type="button"
              onClick={toggle}
          ...
          <p className="mt-1 text-xs leading-5 text-slate-300">Menos ruido, más enfoque. Entra, mira tu tablero y trabaja.</p>
        </div>
      )}
