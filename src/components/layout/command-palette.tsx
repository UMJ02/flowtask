...
const COMMANDS: CommandItem[] = [
  ...
  },
  {
    id: 'settings',
    label: 'Abrir ajustes',
    description: 'Ajusta avisos, contexto y comportamiento de la aplicación.',
    href: '/app/settings',
  ...
  },
  {
    id: 'profile',
    label: 'Abrir perfil',
    description: 'Actualiza nombre visible, imagen y contraseña.',
    href: '/app/profile',
    keywords: ['perfil', 'cuenta', 'avatar', 'password'],
    icon: UserCircle2,
    section: 'Accesos',
  },
];
