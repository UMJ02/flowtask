...
type CommandItem = {
  ...
  section?: 'Favoritos' | 'Fijados' | 'Recientes' | 'Accesos' | 'Vistas guardadas';
};
...
const COMMANDS: CommandItem[] = [
  ...
  {
    id: 'intelligence',
    label: 'Abrir intelligence',
    description: 'Lee riesgos, foco y capacidad en una sola vista.',
  ...
  },
  {
    ...
    description: 'Resume avances y exporta PDFs.',
    href: '/app/reports',
