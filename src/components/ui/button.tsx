  ...
  return (
    <button
      className={cn(
        ...
        size === "icon" && "h-10 w-10 rounded-2xl p-0 text-[14px]",
        variant === "primary" && "bg-slate-950 text-white shadow-[0_10px_24px_rgba(15,23,42,0.10)] hover:-translate-y-0.5 hover:bg-slate-900 hover:shadow-[0_12px_28px_rgba(15,23,42,0.14)]",
        variant === "secondary" && "border border-[#E7ECF3] bg-white text-slate-900 shadow-[0_1px_2px_rgba(15,23,42,0.02)] hover:-translate-y-0.5 hover:border-slate-300 hover:bg-slate-50",
