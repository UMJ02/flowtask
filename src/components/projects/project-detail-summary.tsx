      ...
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0 flex-1">
            <Link href={projectListRoute(currentQuery)} className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 text-sm font-semibold text-slate-500 transition hover:bg-slate-50 hover:text-slate-900" aria-label="Volver al listado">
          ...
          <div className="flex flex-wrap items-center gap-2 lg:max-w-[560px] lg:justify-end">
            ...
            <Link href={projectEditRoute(project.id, currentQuery)} className="inline-flex h-12 items-center justify-center rounded-[22px] border border-slate-200 bg-white px-5 text-sm font-semibold text-slate-900 transition hover:-translate-y-0.5 hover:bg-slate-50">
              Editar proyecto
            </Link>
            <button
              type="button"
