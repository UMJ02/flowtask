...
export function ProjectDetailSummary({ project, currentQuery = "" }: { project: any; currentQuery?: string }) {
  ...
  return (
    <Card className="rounded-[20px] border border-slate-200/85 bg-white p-5 md:p-5">
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0 flex-1">
            ...
            <h1 className="mt-5 text-[28px] font-bold tracking-tight text-slate-900 md:text-[28px]">{project.title}</h1>
          ...
          <div className="flex flex-wrap items-center gap-2 lg:max-w-[520px] lg:justify-end">
            ...
            <button
              ...
              className="inline-flex h-10 items-center gap-2 rounded-[20px] border border-slate-200 bg-white px-4 text-[13px] font-semibold text-slate-700 transition hover:bg-slate-50"
            >
