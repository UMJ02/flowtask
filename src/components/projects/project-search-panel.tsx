...
export function ProjectSearchPanel({ filters }: ProjectSearchPanelProps) {
  ...
  return (
    <form method="get" className="rounded-[24px] border border-slate-200/90 bg-white/[0.92] p-5">
        ...
        <div className="min-w-0 flex-1">
          <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h2 className="mt-1 text-base font-semibold text-slate-900">Encuentra un proyecto y abre filtros solo cuando hagan falta</h2>
            </div>
          ...
          <div className="flex flex-col gap-3 lg:flex-row">
            <label className="relative block min-w-0 flex-1">
              ...
              <Input
                className="h-10 rounded-[20px] pl-11 text-base"
            ...
            <div className="flex flex-wrap gap-3">
              <button
                ...
                className={cn(
                  'inline-flex h-10 items-center gap-2 rounded-[20px] border px-4 text-sm font-semibold transition',
                  advancedOpen
              ...
              <Button className="h-10 rounded-[20px] px-5" type="submit">Buscar</Button>

              <Link href="/app/projects" className="inline-flex">
                <Button className="h-10 rounded-[20px] px-5" type="button" variant="secondary">Limpiar</Button>
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-[22px] border border-slate-200 bg-[linear-gradient(180deg,rgba(248,250,252,0.95),rgba(255,255,255,0.98))] p-4">
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
              <label className="block">
                ...
                <Select className="h-10 rounded-[16px]" defaultValue={filters.status ?? ''} name="status">
              ...
              <label className="block">
                ...
                <Select className="h-10 rounded-[16px]" defaultValue={filters.department ?? ''} name="department">
              ...
              <label className="block">
                ...
                <Select className="h-10 rounded-[16px]" defaultValue={filters.mode ?? ''} name="mode">
              ...
              <label className="block">
                ...
                <Input className="h-10 rounded-[16px]" defaultValue={filters.client ?? ''} name="client" placeholder="Nombre del cliente" />
              </label>
            </div>
          </div>
        </div>
