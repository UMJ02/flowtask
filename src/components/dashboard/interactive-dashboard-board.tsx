              ...
              {(['task', 'projects', 'calendar', 'kanban'] as PanelKey[]).map((key) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'flex w-full min-w-0 items-start gap-3 rounded-2xl border px-3 py-3 text-left transition duration-200',
            ...
            {activePanels.includes('kanban') ? (
              <div className="mb-4 rounded-[16px] border border-emerald-200 bg-gradient-to-br from-white via-emerald-50/40 to-white p-4 md:p-3">
                <div className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-[16px] border border-emerald-100 bg-white/[0.80] px-4 py-3">
                  ...
                  <div className="flex items-center gap-2">
                    <button type="button" onClick={() => toggleExpanded('kanban')} className="inline-flex h-11 items-center gap-2 rounded-full bg-emerald-500 px-4 text-sm font-semibold text-white transition hover:bg-emerald-400">
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="ft-copy">Guarda recordatorios al vuelo y edítalos directo dentro de cada fila.</p>
                </div>
              </div>
