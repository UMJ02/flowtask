          ...
          <div className="grid gap-4 xl:grid-cols-[1.35fr_0.65fr]">
            ...
            <Card className="border-slate-200 bg-white p-4 md:p-5 transition hover:shadow-md">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">Deja avisos rápidos para organizarte durante el dia.</p>
              </div>
              <div className="mt-4 flex gap-2">
                ...
                />
                <button type="button" onClick={addReminder} className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-500 text-white transition hover:-translate-y-0.5 hover:bg-emerald-400" aria-label="Agregar aviso">
