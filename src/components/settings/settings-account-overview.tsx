        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid gap-3 md:grid-cols-4">
            <div className="rounded-[26px] bg-white/10 px-4 py-3 ring-1 ring-white/10">
              ...
              <p className="mt-1 text-sm text-slate-300">{activeOrganization ? roleLabel(activeOrganization.role) : 'Sin organización detectada'}</p>
            </div>
            <div className="rounded-[26px] bg-white/10 px-4 py-3 ring-1 ring-white/10">
              <div className="flex items-center gap-2 text-emerald-300">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  {activeOrganization
                    ? `${activeOrganization.name} · ${roleLabel(activeOrganization.role)}`
