      ...
      <div className="grid gap-4 xl:grid-cols-2">
        ...
        <div className="rounded-[22px] border border-[#E2E8F0] bg-white p-4 shadow-[0_8px_24px_rgba(15,23,42,0.035)]">
          ...
          <div className="space-y-3">
            ...
            {!activity.length ? (
              <p className="rounded-[16px] bg-[#F8FAFC] p-4 text-sm font-semibold text-[#64748B] ring-1 ring-[#E2E8F0]">Los cambios aparecerán aquí cuando la tarea tenga movimientos.</p>
            ) : null}
          </div>
