...
export function TaskComments({ taskId, comments, canComment = true }: { taskId: string; comments: any[]; canComment?: boolean }) {
  return (
    <Card>
      ...
      <div className="mt-4">
        <CommentComposer taskId={taskId} canComment={canComment} />
      </div>
    </Card>
  );
}
