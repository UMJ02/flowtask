    ...
    <div className="space-y-5 pt-2 md:pt-3">
      <section className="grid items-start gap-4 xl:grid-cols-[minmax(0,1fr)_460px]">
        <div>
          ...
          <h1 className="mt-2 text-[24px] font-semibold tracking-[-0.028em] text-slate-950 md:text-[28px]">Catálogos del workspace para proyectos y tareas</h1>
