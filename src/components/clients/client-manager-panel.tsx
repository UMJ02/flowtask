    ...
    <div className="space-y-5">
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_560px]">
        <div>
          ...
          <h1 className="mt-3 text-[28px] font-semibold tracking-[-0.04em] text-slate-950 md:text-[32px]">Catálogos del workspace para proyectos y tareas</h1>
      ...
      <Card className="overflow-hidden rounded-[24px] border border-slate-200/90 bg-white">
        ...
        <div className="px-5 py-5">
          ...
          <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            ...
            <button type="button" onClick={() => openCreate(activeTab)} className="inline-flex h-10 items-center justify-center gap-2 rounded-2xl bg-slate-950 px-5 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-slate-900">
          ...
          <div className="mb-5 flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              <button type="button" onClick={() => { setQuery(''); setStatusFilter('all'); }} className="inline-flex h-10 items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 text-sm font-bold text-slate-700 transition hover:bg-slate-50"><Filter className="h-4 w-4" /> Limpiar filtros</button>
              {activeTab === 'clients' ? (
                <label className="relative inline-flex h-10 items-center rounded-2xl border border-slate-200 bg-white px-4 text-sm font-bold text-slate-700">
      ...
      {activeTab === 'clients' ? (
        <Card className="rounded-[24px] border border-slate-200/90 bg-white p-5">
