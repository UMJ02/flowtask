        ...
        <div className="px-5 py-6">
          ...
          <div className="mb-5 flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              <button type="button" onClick={() => { setQuery(''); setStatusFilter('all'); }} className="inline-flex h-12 items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 text-sm font-bold text-slate-700 transition hover:bg-slate-50"><Filter className="h-4 w-4" /> Limpiar filtros</button>
              {activeTab === 'clients' ? (
