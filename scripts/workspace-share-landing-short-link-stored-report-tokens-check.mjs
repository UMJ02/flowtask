...
if (!['58.28.21.4-share-landing-short-link-stored-report-tokens', '58.28.21.5-radar-analytics-due-state-integrity',
  '58.28.21.6-data-integrity-live-sync-audit'].includes(pkg.version)) failures.push('unexpected package version');
