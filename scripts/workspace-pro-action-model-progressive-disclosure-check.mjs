...
const allowedVerifyTargets = ["npm run verify:v58.28.2", "npm run verify:v58.28.3"];
...
const pageMarkers = ["ws-pro-action-menu", "ws-pro-action-menu-item", "TASK_PRIORITY_ACTIONS", "updateTaskPriority", "Vista limpia", "Gestionar"];
...
const cssMarkers = ["ws-pro-action-menu", "ws-pro-action-menu-item", "ws-pro-table-action", "ft-ws-spaces-help-card"];
