...
if (!pkg.includes('verify:v58.27.6') && !pkg.includes('verify:v58.27.7') && !pkg.includes('verify:v58.27.7.1') && !pkg.includes('verify:v58.27.8') && !pkg.includes('verify:v58.27.8.1')) errors.push('verify:current is not aligned to active v58.27.x');
if (errors.length) {
