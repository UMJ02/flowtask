...
const allowed = ["58.28.12-workspace-pro-home-hero-solid-card-colors", "58.28.13-workspace-pro-final-cleanup-audit-safe-dead-surface-removal"];
const allowedVerify = ["npm run verify:v58.28.12", "npm run verify:v58.28.13"];
