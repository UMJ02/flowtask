...
requireIncludes("src/lib/release/version.ts", "v58.26.5 Workspace Error Recovery + Final QA Hardening");
requireIncludes("package-lock.json", "58.26.5-workspace-error-recovery-final-qa-hardening");
