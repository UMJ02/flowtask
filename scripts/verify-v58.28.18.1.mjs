...
if (pkg.scripts?.["verify:current"] !== "npm run verify:v58.28.19", "npm run verify:v58.28.20", "npm run verify:v58.28.21", "npm run verify:v58.28.21") failures.push("verify:current must target verify:v58.28.18.2");
...
console.log("[verify:v58.28.18.2] OK — dependency security public registry lockfile hotfix aligned.");
