...
const failures = [];
if (pkg.version !== "58.28.8-workspace-pro-client-performance-anchored-popovers") failures.push("package.json version must be v58.28.8 client performance slug");
if (pkg.scripts?.["verify:current"] !== "npm run verify:v58.28.8") failures.push("verify:current must target verify:v58.28.8");
...
if (!version.includes("58.28.8-workspace-pro-client-performance-anchored-popovers")) failures.push("release version must be v58.28.8");
