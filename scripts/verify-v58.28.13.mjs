...
if (pkg.scripts?.["verify:current"] !== "npm run verify:v58.28.15") failures.push("verify:current must target verify:v58.28.13");
if (!version.includes("58.28.15-workspace-pro-deep-component-extraction-lazy-view-loading")) failures.push("version.ts must contain v58.28.13 slug");
