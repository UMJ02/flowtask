...
if (!page.includes('getWorkspaceProDerivedData({ tasks, projects, boards, files, activity, projectViews })') && !page.includes('getWorkspaceProDerivedData({ tasks: activeTasks, projects, boards, files, activity, projectViews })')) failures.push('WorkspaceProPage must memoize derived data once');
