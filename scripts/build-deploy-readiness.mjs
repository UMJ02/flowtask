...
const failures = [];
const expectedVersion = "58.15.3.6-task-editor-width-alignment";
const expectedReleaseLabel = "V58.15.3.6";
...
requireFile("scripts/verify-v58.15.3.6.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.15.3.6") failures.push("verify:current must target verify:v58.15.3.6");
if (scripts["verify:v58.15.3.6"] !== "node scripts/verify-v58.15.3.6.mjs") failures.push("verify:v58.15.3.6 must target scripts/verify-v58.15.3.6.mjs");
...
console.log("[build-deploy-readiness] OK — V58.15.3.6 package, env, release exports y continuidad maestra alineados.");
