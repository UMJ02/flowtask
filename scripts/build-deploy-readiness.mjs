...
const failures = [];
const expectedVersion = "58.15.3.8-task-editor-full-bleed-rounded-hero";
const expectedReleaseLabel = "V58.15.3.8";
...
requireFile("scripts/verify-v58.15.3.8.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.15.3.8") failures.push("verify:current must target verify:v58.15.3.8");
if (scripts["verify:v58.15.3.8"] !== "node scripts/verify-v58.15.3.8.mjs") failures.push("verify:v58.15.3.8 must target scripts/verify-v58.15.3.8.mjs");
...
console.log("[build-deploy-readiness] OK — V58.15.3.8 package, env, release exports y continuidad maestra alineados.");
