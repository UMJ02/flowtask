...
const expectedReleaseLabel = "V58.12.2";
...
requireFile("scripts/verify-v58.12.2.mjs");
requireFile("docs/release/V58_12_2_ORGANIZATION_DELETE_NOW_FIX.md");
...
if (scripts["verify:current"] !== "npm run verify:v58.12.2") failures.push("verify:current must target verify:v58.12.2");
if (scripts["verify:v58.12.2"] !== "node scripts/verify-v58.12.2.mjs") failures.push("verify:v58.12.2 must target scripts/verify-v58.12.2.mjs");
