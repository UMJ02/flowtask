...
const failures = [];
const expectedVersion = "58.15.3.3-workspace-scope-catalog-fix";
const expectedReleaseLabel = "V58.15.3.3";
...
requireFile("scripts/verify-v58.15.3.3.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.15.3.3") failures.push("verify:current must target verify:v58.15.3.3");
if (scripts["verify:v58.15.3.3"] !== "node scripts/verify-v58.15.3.3.mjs") failures.push("verify:v58.15.3.3 must target scripts/verify-v58.15.3.3.mjs");
...
console.log("[build-deploy-readiness] OK — V58.15.3.3 package, env, release exports y continuidad maestra alineados.");
