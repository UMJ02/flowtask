...
const failures = [];
const expectedVersion = "58.15.3.7-task-editor-edge-alignment";
const expectedReleaseLabel = "V58.15.3.7";
...
requireFile("scripts/verify-v58.15.3.7.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.15.3.7") failures.push("verify:current must target verify:v58.15.3.7");
if (scripts["verify:v58.15.3.7"] !== "node scripts/verify-v58.15.3.7.mjs") failures.push("verify:v58.15.3.7 must target scripts/verify-v58.15.3.7.mjs");
...
console.log("[build-deploy-readiness] OK — V58.15.3.7 package, env, release exports y continuidad maestra alineados.");
