...
const failures = [];
const expectedVersion = "58.12.4-registry-integrity-form-persistence-delete-hardfix";
const expectedReleaseLabel = "V58.12.4";
...
requireFile("scripts/verify-v58.12.4.mjs");
requireFile("docs/release/V58_12_4_REGISTRY_INTEGRITY_FORM_PERSISTENCE_DELETE_HARDFIX.md");
...
if (scripts["verify:current"] !== "npm run verify:v58.12.4") failures.push("verify:current must target verify:v58.12.4");
if (scripts["verify:v58.12.4"] !== "node scripts/verify-v58.12.4.mjs") failures.push("verify:v58.12.4 must target scripts/verify-v58.12.4.mjs");
