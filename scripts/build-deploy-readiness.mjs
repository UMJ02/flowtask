...
const failures = [];
const expectedVersion = "58.13.1-workspace-v2-pro";
const expectedReleaseLabel = "V58.13.1";
...
requireFile("scripts/verify-v58.13.1.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.13.1") failures.push("verify:current must target verify:v58.13.1");
if (scripts["verify:v58.13.1"] !== "node scripts/verify-v58.13.1.mjs") failures.push("verify:v58.13.1 must target scripts/verify-v58.13.1.mjs");
...
console.log("[build-deploy-readiness] OK — V58.13.1 package, env, release exports y continuidad maestra alineados.");
