...
const expectedReleaseLabel = "v58.21.8 Spacing Governance + Microinteraction Polish";
...
[
  ...
  "scripts/runtime-check.mjs","scripts/validate-env.mjs","scripts/verify-v58.21.8.mjs",
  "docs/release/DB_CONTINUITY_SOURCE_OF_TRUTH.md",
  "docs/release/V58_21_8_SPACING_GOVERNANCE_MICROINTERACTION_POLISH.md",
  "docs/qa/FLOWTASK_V58_21_8_SPACING_MOTION_QA.md",
  "docs/design-system/FLOWTASK_DESIGN_SYSTEM.md",
  "docs/design-system/FLOWTASK_LIVING_SYSTEM.md",
  "docs/design-system/FLOWTASK_SPACING_MOTION_GOVERNANCE.md",
...
for (const scriptName of ["build", "vercel:build", "deploy:readiness", "build:preflight", "verify:current", "deploy:production:ready", "verify:v58.21.8"]) if (!scripts[scriptName]) failures.push(`Missing package script: ${scriptName}`);
...
if (scripts["verify:v58.21.8"] !== "node scripts/verify-v58.21.8.mjs") failures.push("verify:v58.21.8 must target scripts/verify-v58.21.8.mjs");
...
console.log("[build-deploy-readiness] OK — v58.21.8 package, env, release exports and spacing governance readiness aligned.");
