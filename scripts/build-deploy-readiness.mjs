...
const failures = [];
const expectedVersion = "58.11.1-premium-polish-soft-delete-reactivation";
const expectedReleaseLabel = "V58.11.1";
...
requireFile("scripts/verify-v58.11.1.mjs");
requireFile("docs/release/V58_11_1_PREMIUM_POLISH_SOFT_DELETE_REACTIVATION.md");
...
if (scripts["verify:current"] !== "npm run verify:v58.11.1") failures.push("verify:current must target verify:v58.11.1");
if (scripts["verify:v58.11.1"] !== "node scripts/verify-v58.11.1.mjs") failures.push("verify:v58.11.1 must target scripts/verify-v58.11.1.mjs");
