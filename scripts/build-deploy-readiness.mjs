...
const failures = [];
const expectedVersion = "58.11.7.1-form-persistence-and-assistant-size-fix-hotfix";
const expectedReleaseLabel = "V58.11.7.1";
...
requireFile("scripts/verify-v58.11.7.1.mjs");
requireFile("docs/release/V58_11_7_1_FORM_PERSISTENCE_AND_ASSISTANT_SIZE_FIX_HOTFIX.md");
...
if (scripts["verify:current"] !== "npm run verify:v58.11.7.1") failures.push("verify:current must target verify:v58.11.7.1");
if (scripts["verify:v58.11.7.1"] !== "node scripts/verify-v58.11.7.1.mjs") failures.push("verify:v58.11.7.1 must target scripts/verify-v58.11.7.1.mjs");
