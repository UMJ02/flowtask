...
const failures = [];
const expectedVersion = "58.16-project-task-architecture";
const expectedReleaseLabel = "V58.16";
...
requireFile("scripts/verify-v58.16.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.16") failures.push("verify:current must target verify:v58.16");
if (scripts["verify:v58.16"] !== "node scripts/verify-v58.16.mjs") failures.push("verify:v58.16 must target scripts/verify-v58.16.mjs");
...
console.log("[build-deploy-readiness] OK — V58.16 package, env, release exports y continuidad maestra alineados.");
