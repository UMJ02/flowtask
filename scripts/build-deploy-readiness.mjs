...
const expectedVersion = "58.27.4-workspace-pro-board-drag-drop-inline-editing";
...
console.log("[build-deploy-readiness] OK — v58.27.4 workspace doctor version alignment aligned.");
