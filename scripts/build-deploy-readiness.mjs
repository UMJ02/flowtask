...
const failures = [];
const expectedVersion = "58.15.3.9-project-list-title-input-fix";
const expectedReleaseLabel = "V58.15.3.9";
...
requireFile("scripts/verify-v58.15.3.9.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.15.3.9") failures.push("verify:current must target verify:v58.15.3.9");
if (scripts["verify:v58.15.3.9"] !== "node scripts/verify-v58.15.3.9.mjs") failures.push("verify:v58.15.3.9 must target scripts/verify-v58.15.3.9.mjs");
...
console.log("[build-deploy-readiness] OK — V58.15.3.9 package, env, release exports y continuidad maestra alineados.");
