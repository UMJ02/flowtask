...
const failures = [];
const expectedVersion = "58.16.2-ver-proyecto-premium-2026";
const expectedReleaseLabel = "V58.16.2";
...
requireFile("scripts/verify-v58.16.2.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.16.2") failures.push("verify:current must target verify:v58.16.2");
if (scripts["verify:v58.16.2"] !== "node scripts/verify-v58.16.2.mjs") failures.push("verify:v58.16.2 must target scripts/verify-v58.16.2.mjs");
...
console.log("[build-deploy-readiness] OK — V58.16.2 package, env, release exports y continuidad maestra alineados.");
