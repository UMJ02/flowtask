...
const failures = [];
const expectedVersion = "58.13.6-projects-list-pro";
const expectedReleaseLabel = "V58.13.6";
...
requireFile("scripts/verify-v58.13.6.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.13.6") failures.push("verify:current must target verify:v58.13.6");
if (scripts["verify:v58.13.6"] !== "node scripts/verify-v58.13.6.mjs") failures.push("verify:v58.13.6 must target scripts/verify-v58.13.6.mjs");
...
console.log("[build-deploy-readiness] OK — V58.13.6 package, env, release exports y continuidad maestra alineados.");
