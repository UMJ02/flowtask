...
const failures = [];
const expectedVersion = "58.15.3.5-task-editor-project-client-media";
const expectedReleaseLabel = "V58.15.3.5";
...
requireFile("scripts/verify-v58.15.3.5.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.15.3.5") failures.push("verify:current must target verify:v58.15.3.5");
if (scripts["verify:v58.15.3.5"] !== "node scripts/verify-v58.15.3.5.mjs") failures.push("verify:v58.15.3.5 must target scripts/verify-v58.15.3.5.mjs");
...
console.log("[build-deploy-readiness] OK — V58.15.3.5 package, env, release exports y continuidad maestra alineados.");
