...
const failures = [];
const expectedVersion = "58.16.1-project-detail-tasks-inline";
const expectedReleaseLabel = "V58.16.1";
...
requireFile("scripts/verify-v58.16.1.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.16.1") failures.push("verify:current must target verify:v58.16.1");
if (scripts["verify:v58.16.1"] !== "node scripts/verify-v58.16.1.mjs") failures.push("verify:v58.16.1 must target scripts/verify-v58.16.1.mjs");
...
console.log("[build-deploy-readiness] OK — V58.16.1 package, env, release exports y continuidad maestra alineados.");
