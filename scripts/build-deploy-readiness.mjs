...
const failures = [];
const expectedVersion = "58.16.3-ver-proyecto-premium-design-match";
const expectedReleaseLabel = "V58.16.3";
...
requireFile("scripts/verify-v58.16.3.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.16.3") failures.push("verify:current must target verify:v58.16.3");
if (scripts["verify:v58.16.3"] !== "node scripts/verify-v58.16.3.mjs") failures.push("verify:v58.16.3 must target scripts/verify-v58.16.3.mjs");
...
console.log("[build-deploy-readiness] OK — V58.16.3 package, env, release exports y continuidad maestra alineados.");
