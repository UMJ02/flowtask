...
const failures = [];
const expectedVersion = "58.15.3.4-select-scope-stability-fix";
const expectedReleaseLabel = "V58.15.3.4";
...
requireFile("scripts/verify-v58.15.3.4.mjs");
...
if (scripts["verify:current"] !== "npm run verify:v58.15.3.4") failures.push("verify:current must target verify:v58.15.3.4");
if (scripts["verify:v58.15.3.4"] !== "node scripts/verify-v58.15.3.4.mjs") failures.push("verify:v58.15.3.4 must target scripts/verify-v58.15.3.4.mjs");
...
console.log("[build-deploy-readiness] OK — V58.15.3.4 package, env, release exports y continuidad maestra alineados.");
