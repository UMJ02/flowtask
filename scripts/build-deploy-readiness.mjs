...
if (!["npm run verify:v58.27.6", "npm run verify:v58.27.7", "npm run verify:v58.27.7.1"].includes(pkg.scripts?.["verify:current"])) failures.push("verify:current must target the active v58.27.x verify script");
