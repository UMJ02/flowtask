...
const expectedReleaseLabel = "V58.12.3";
...
requireFile("scripts/verify-v58.12.3.mjs");
requireFile("docs/release/V58_12_3_ORGANIZATION_DELETE_NOW_HARDFIX.md");
...
if (scripts["verify:current"] !== "npm run verify:v58.12.3") failures.push("verify:current must target verify:v58.12.3");
if (scripts["verify:v58.12.3"] !== "node scripts/verify-v58.12.3.mjs") failures.push("verify:v58.12.3 must target scripts/verify-v58.12.3.mjs");
