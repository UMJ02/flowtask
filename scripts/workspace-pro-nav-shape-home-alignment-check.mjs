...
const allowed = ["58.28.11-workspace-pro-nav-shape-home-alignment", "58.28.12-workspace-pro-home-hero-solid-card-colors", "58.28.13-workspace-pro-final-cleanup-audit-safe-dead-surface-removal"];
const allowedVerify = ["npm run verify:v58.28.11", "npm run verify:v58.28.12", "npm run verify:v58.28.13"];
...
if (failures.length) { console.error("[workspace:nav-shape-home-align:ready] FAIL"); for (const failure of failures) console.error(`- ${failure}`); process.exit(1); }
