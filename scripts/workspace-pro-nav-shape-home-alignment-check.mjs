...
const allowed = ["58.28.11-workspace-pro-nav-shape-home-alignment", "58.28.12-workspace-pro-home-hero-solid-card-colors", "58.28.14-workspace-pro-component-split-runtime-slimdown"];
const allowedVerify = ["npm run verify:v58.28.11", "npm run verify:v58.28.12", "npm run verify:v58.28.14"];
