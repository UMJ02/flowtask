...
if (pkg.version !== "58.28.12-workspace-pro-home-hero-solid-card-colors") failures.push("Unexpected package version");
if (pkg.scripts?.["verify:current"] !== "npm run verify:v58.28.12") failures.push("verify:current must target verify:v58.28.12");
if (!version.includes("58.28.12-workspace-pro-home-hero-solid-card-colors")) failures.push("version.ts must contain v58.28.12 slug");
