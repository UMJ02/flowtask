...
if (scripts["verify:current"] !== "npm run verify:v58.25.8.6") failures.push("verify:current must target verify:v58.25.8.6");
if (scripts["verify:v58.25.8.6"] !== "node scripts/verify-v58.25.8.6.mjs") failures.push("verify:v58.25.8.6 must target scripts/verify-v58.25.8.6.mjs");
...
console.log("[deploy-production-readiness] OK — v58.25.8.6 workspace responsive polish + right panel ux readiness aligned.");
