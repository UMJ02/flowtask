...
if (scripts["verify:current"] !== "npm run verify:v58.26.5") failures.push("verify:current must target verify:v58.26.5");
if (scripts["verify:v58.26.5"] !== "node scripts/verify-v58.26.5.mjs") failures.push("verify:v58.26.5 must target scripts/verify-v58.26.5.mjs");
...
console.log("[deploy-production-readiness] OK — v58.26.5 workspace error recovery and final QA hardening aligned.");
