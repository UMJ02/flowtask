...
if (scripts["verify:v58.27.0"] !== "node scripts/verify-v58.27.0.mjs") failures.push("verify:v58.27.0 must target scripts/verify-v58.27.0.mjs");
...
console.log("[deploy-production-readiness] OK — v58.27.0 client final release candidate aligned.");
