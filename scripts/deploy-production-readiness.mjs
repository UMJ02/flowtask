...
for (const rel of [
  ...
  "scripts/verify-v58.25.6.6.mjs",
  "docs/release/V58_25_6_6_BOARDS_FLOATING_LAYOUT_PROPERTIES_REDESIGN.md",
  "docs/qa/FLOWTASK_V58_25_6_6_BOARDS_FLOATING_LAYOUT_PROPERTIES_REDESIGN_QA.md",
...
if (scripts["verify:current"] !== "npm run verify:v58.25.6.6") failures.push("verify:current must target verify:v58.25.6.6");
