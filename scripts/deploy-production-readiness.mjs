...
if (scripts["verify:current"] !== "npm run verify:v58.26.4") failures.push("verify:current must target verify:v58.26.4");
if (scripts["verify:v58.26.4"] !== "node scripts/verify-v58.26.4.mjs") failures.push("verify:v58.26.4 must target scripts/verify-v58.26.4.mjs");
...
console.log("[deploy-production-readiness] OK — v58.26.4 workspace collaboration, share and mobile polish aligned.");
