...
const failures = [];
if (pkg.version !== "58.28.6-workspace-pro-completed-filter-anchored-actions") failures.push("package.json version must be v58.28.6 completed filter slug");
...
if (!version.includes("58.28.6-workspace-pro-completed-filter-anchored-actions")) failures.push("release version must be v58.28.6");
