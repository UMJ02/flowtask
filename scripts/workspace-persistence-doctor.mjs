...
const allowedVerifyTargets = [
  ...
  "npm run verify:v58.28.11", "npm run verify:v58.28.12", "npm run verify:v58.28.15", "npm run verify:v58.28.16", "npm run verify:v58.28.16.1", "npm run verify:v58.28.16.2",
];
...
if (!allowedVersions.some((version) => versionText.includes(version))) {
...
console.log("[workspace:doctor] OK — Workspace core files aligned.");
