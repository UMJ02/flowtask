...
if (!['npm run verify:v58.28.17.1', 'npm run verify:v58.28.19', 'npm run verify:v58.28.20', 'npm run verify:v58.28.21', 'npm run verify:v58.28.21.3', 'npm run verify:v58.28.21.4', 'npm run verify:v58.28.21.5',
  'npm run verify:v58.28.21.6'].includes(pkg.scripts?.['verify:current'])) failures.push('verify:current must target the active v58.28.17+ verify script');
