...
if (missing.length || forbidden.length) {
  console.error('[verify-v55] Repo verification failed.');
...
console.log('[verify-v55] OK — repo limpio, contrato de entorno listo y base endurecida para cierre técnico.');
