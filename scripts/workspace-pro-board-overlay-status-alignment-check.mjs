...
if (!["npm run verify:v58.28.4", "npm run verify:v58.28.5",
  ...
  "npm run verify:v58.28.10", "npm run verify:v58.28.11", "npm run verify:v58.28.12"].includes(pkg.scripts?.["verify:current"])) failures.push("verify:current must target verify:v58.28.4");
