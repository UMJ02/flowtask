...
if (pkg.scripts?.["verify:current"] !== "npm run verify:v58.28.21.2") failures.push("verify:current must target verify:v58.28.21.2");
...
if (!versionText.includes(expectedVersion)) failures.push("version.ts must contain v58.28.21.2 slug");
...
if (!editor.includes("ft-project-edit-shell") || !editor.includes("ft-project-edit-hero-grid") || !editor.includes("ft-project-edit-meta-grid")) failures.push("inline project editor must use aligned edit form shell, hero grid and meta grid");
...
if (!existsSync("docs/qa/FLOWTASK_V58_28_21_2_CLASSIC_PROJECT_EDIT_FORM_ALIGNMENT_QA.md")) failures.push("missing QA doc for classic project detail UX polish");
...
console.log("[verify:v58.28.21.2] OK — Classic project edit form alignment aligned.");
