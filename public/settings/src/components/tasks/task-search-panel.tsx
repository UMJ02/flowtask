...
export function TaskSearchPanel({ filters }: TaskSearchPanelProps) {
  ...
  return (
    <form method="get" className="space-y-4 rounded-[24px] border ft-border bg-white p-5">
      ...
      <div className="grid gap-3 xl:grid-cols-[minmax(260px,1.4fr)_auto_auto_auto_auto_auto_auto] xl:items-center">
        <label className="relative block">
          ...
          <Input
            className="h-10 rounded-[16px] ft-border bg-white pl-11 text-sm shadow-none placeholder:text-slate-400"
        ...
        <label className="inline-flex h-10 items-center gap-2 rounded-[16px] border ft-border bg-white px-4 text-sm font-bold text-slate-700">
        ...
        <Button className="h-10 rounded-[16px] ft-border bg-white px-4 ft-text-main" type="submit" variant="secondary">
        ...
        <Select className="h-10 min-w-[130px] rounded-[16px] ft-border text-sm font-semibold text-slate-700" defaultValue={filters.status ?? ''} name="status" aria-label="Estado">
        ...
        <Select className="h-10 min-w-[130px] rounded-[16px] ft-border text-sm font-semibold text-slate-700" defaultValue={filters.priority ?? ''} name="priority" aria-label="Prioridad">
        ...
        <Select className="h-10 min-w-[130px] rounded-[16px] ft-border text-sm font-semibold text-slate-700" defaultValue={filters.department ?? ''} name="department" aria-label="Área">
        ...
        <Select className="h-10 min-w-[130px] rounded-[16px] ft-border text-sm font-semibold text-slate-700" defaultValue={filters.due ?? ''} name="due" aria-label="Fecha">
      ...
      {activeChips.length ? (
        <div className="flex flex-col gap-3 border-t ft-border pt-4 md:flex-row md:items-center md:justify-between">
